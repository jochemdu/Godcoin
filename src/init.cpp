    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("godcoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  godcoind [options]                     " + "\n" +
                  "  godcoind [options] <command> [params]  " + _("Send command to -server or godcoind") + "\n" +
                  "  godcoind [options] help                " + _("List commands") + "\n" +
                  "  godcoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: godcoind.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the godcoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. godcoin is probably already running."), strDataDir.c_str()));
